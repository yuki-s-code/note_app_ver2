...
import { setCreateUser, selectCreateUser } from "../../slices/userSlice";
import { useMutateUser } from "../../libs/hooks/loginHook/useMutateUser";
import { Link } from "react-router-dom";

const UserCreate: FC = () => {
  const dispatch = useAppDispatch();
  const user: any = useAppSelector(selectCreateUser);
  console.log(user);
  ...
  const submitHandler = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (user.userid !== "") {
      window.localStorage.sns_id = user.userid;
...
{
  /* //       classNameName="mb-5 rounded-[4px] border p-3 hover:outline-none focus:outline-none hover:border-yellow-500"
    //       type="text"
    ...
    //     />
    //     <input
    //       classNameName="border rounded-[4px] p-3 hover:outline-none focus:outline-none hover:border-yellow-500"
    //       type="password"
    //       placeholder="Password"
    //       onChange={(e) => {
    //         ha    // <>
    //   <div classNameName="flex flex-col text-sm rounded-md">
    //     <inputndleChange(e, "passwd");
    //       }}
    //     />
    //   </div>
    //   <button
    //     classNameName="mt-5 w-full border p-2 bg-gradient-to-r from-gray-800 bg-gray-500 text-white rounded-[4px] hover:bg-slate-400 scale-105 duration-300"
    //     type="submit"
    //     onClick={(e: any) => {
    //       submitHandler(e);
    //     }}
    ...
    //     Create
    //   </button>
    //   <div classNameName="mt-5 flex justify-between text-sm text-gray-600">
    //     <a href="/">Sign in</a>
    //   </div>
    // </> */
}
